...
from lexicon.lexicon import UserKeyboardsLexicon, AdminKeyboardsLexicon
...
class InlineAdminKeyboards:
    ...
    initial_admin_keyboard: InlineKeyboardMarkup = InlineKeyboardMarkup(
        inline_keyboard=[[InlineAdminButtons.get_links_button, InlineAdminButtons.edit_links_button],
                         [InlineAdminButtons.make_push_button]]

    )

    edit_links_keyboard: InlineKeyboardMarkup = InlineKeyboardMarkup(
        inline_keyboard=[[InlineAdminButtons.edit_main_link_button, InlineAdminButtons.edit_second_link_button],
